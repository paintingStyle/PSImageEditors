...
- (void)setup {
    ...
    if (!_mosaicView) {
        ...
        self.mosaicView.mosaicImage = [UIImage ps_mosaicImage:self.editor.imageView.image level:35];
...
- (void)changeRectangularMosaic {
    ...
    self.mosaicView.mosaicImage = [UIImage ps_mosaicImage:self.editor.imageView.image level:20];
}
